...
import models.usuarioDispositivo.UsuarioDispositivo
import play.api.libs.json.Json
import org.anormcypher._
import play.api.Logger
import models.connection.Connection
trait UsuarioDispositivoRepositoryComponent {
    val usuarioDispositivoRepository: UsuarioDispositivoRepository
    
    trait UsuarioDispositivoRepository {

        def createUsuarioDispositivo(usuarioDispositivo: UsuarioDispositivo): UsuarioDispositivo

        def listDispositivosByUser(user:String): List[UsuarioDispositivo]
        
    }
}

trait UsuarioDispositivoComponentImpl extends UsuarioDispositivoRepositoryComponent with Connection{
    override val usuarioDispositivoRepository = new UsuarioDispositivoRepositoryImpl
     
   
    
    class UsuarioDispositivoRepositoryImpl extends UsuarioDispositivoRepository {
        
        
        
       override def createUsuarioDispositivo(usuarioDispositivo: UsuarioDispositivo): UsuarioDispositivo {
